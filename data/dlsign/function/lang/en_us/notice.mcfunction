...
execute \
    ...
    run \
        tellraw @s[scores={dlsign.sign_status=0}] \
            ...
            {text:"Luckly, You Will Be the First Signer Today!",color:yellow},\
            {text:"[Click to Sign]",color:blue,\
                hover_event:{action:show_text,\
                    value:{text:"Get the First!",color:gold,bold:1b}},\
