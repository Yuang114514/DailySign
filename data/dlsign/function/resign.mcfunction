#劝退经验不够的玩家
execute as @a[scores={dlsign.resigning=1,dlsign.xp=..29}] run tellraw @s [{text:"[DailySign] ",color:light_purple},{text:"你的经验等级不足哦！快去打经验吧！",color:aqua,bold:true}]
#有经验的玩家可以补签
#消耗经验
...
#结束补签操作
execute as @a[scores={dlsign.resigning=1,dlsign.xp=30..}] run trigger dlsign.resigning set 2
